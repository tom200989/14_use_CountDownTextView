...
public class CountDownTextView extends TextView {
    ...
    private static final int DEFAULT_TOP_COLOR = Color.GREEN;
    private static final int DEFAULT_BOTTOM_COLOR = Color.RED;
...
//        array.recycle();
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        mTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/ArialBlack.ttf");
